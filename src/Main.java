...
class HistoryGenerator {
    ...
    class Translocated {
        ...
        public Translocated(int start, int amount) {
            this.start = start;
            this.amount = amount;
        }
    ...
    void settitle(String s){
     ...
     void event_rate() {
        ...
        if (this.translocation) {
            ...
            this.distribution.add(new Event("translocation", begin, end));
            begin = end;
        }
        if (this.inversion) {
    ...
    void generate() throws IOException {
        ...
        for (int i = 1; i <= this.node_numb; i++) {
            ...
            Queue<Translocated> to_translocate = new LinkedList();
            ...
            while (!to_translocate.isEmpty()) {
                Translocated t = to_translocate.poll();
